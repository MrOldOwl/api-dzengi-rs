...
use crate::{
    ...
    models::{MyTradesRequest, MyTradesResponse},
    switch_url,
};
...
impl Version1<'_> {
    pub async fn my_trades(
        ...
        self.client
            .get(switch_url!("/v1/myTrades", self.demo))
...
mod test {
    ...
    use crate::{crypto::UserSettings, models::MyTradesRequest, rest_api::DzengiRestClient};
