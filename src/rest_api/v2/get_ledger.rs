...
use crate::{
    ...
    models::{LedgerRequest, TransactionDtoResponse},
    switch_url,
};
...
impl Version2<'_> {
    pub async fn ledger(
        ...
        self.client
            .get(switch_url!("/api/v2/ledger", self.demo))
...
mod test {
    ...
    use crate::{crypto::UserSettings, models::LedgerRequest, rest_api::DzengiRestClient};
    ...
    async fn test() {
        ...
        let resp = rest.v2().ledger(LedgerRequest::new()).await.unwrap();
